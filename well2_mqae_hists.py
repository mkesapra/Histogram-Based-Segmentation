...
img = cv2.imread("images_mqae_subBK/20X MQAE 7.5mM well 2_subBK .png",0)
img1 = cv2.imread("images_mqae_subBK/20X MQAE 7.5mM well 2 + IVM t1_subBK.png", 0)
img2 = cv2.imread("images_mqae_subBK/20X MQAE 7.5mM well 2 + IVM t2_subBK.png", 0)
...
sns.distplot(img1.flat,  kde=False)
